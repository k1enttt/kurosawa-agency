...
export const HeaderClient: React.FC<HeaderClientProps> = ({ data }) => {
  ...
  const phoneNumber: TextField = contactInformation?.phone
  const email: TextField = contactInformation?.email
  const workTime: TextField = contactInformation?.workTime
  const facebookUrl: TextField = contactInformation?.facebookUrl
  const xUrl: TextField = contactInformation?.xUrl
  const linkedinUrl: TextField = contactInformation?.linkedinUrl
          ...
          <div className="header-row-1">
            ...
            <div className="flex-1 basis-1/3 flex justify-end">
              ...
              <div className="social-media">
                {/* Facebook */}
                {facebookUrl && (
                  <Link href={facebookUrl} className="text-socialMedia-facebook">
                    <svg
                      width="21"
                      height="21"
                      viewBox="0 0 21 21"
                ...
                {/* X */}
                {xUrl && (
                  <Link href={xUrl} className="text-socialMedia-x">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      x="0px"
                      y="0px"
                ...
                {/* LinkedIn */}
                {linkedinUrl && (
                  <Link href={linkedinUrl} className="text-socialMedia-linkedin">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      x="0px"
                      y="0px"
